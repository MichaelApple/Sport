	...
	<?php if ($twitter_enabled || $facebook_enabled || $google_enabled || $google_plus_enabled|| $yahoo_enabled || $wordpress_enabled) : ?>
		...
		<div class="social_connect_ui <?php if( strpos( $_SERVER['REQUEST_URI'], 'wp-signup.php' ) ) echo 'mu_signup'; ?>">
			...
			<?php if( $display_label !== false ) : ?>
				<label><?php _e( 'Click below to sign in using your social account', 'social_connect' ); ?></label>
			<?php endif; ?>
			<div class="social_connect_form">
			<?php do_action ('social_connect_pre_form'); ?>
				<?php if( $facebook_enabled ) :
					echo apply_filters('social_connect_login_facebook','<a href="javascript:void(0);" title="Facebook" class="social_connect_login_facebook"><img alt="Facebook" src="'.$images_url.'facebook.png" /></a>');
				endif; ?>
				...
				<?php if( $google_plus_enabled ) :
					echo apply_filters('social_connect_login_google_plus','<a href="javascript:void(0);" title="Google+" class="social_connect_login_google_plus"><img alt="Google+" src="'.$images_url.'google_plus.png" /></a>');
				endif; ?>
